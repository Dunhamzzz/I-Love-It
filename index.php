...
<body>
<div id="h">
	<h1>ilo.ve.it <span class="h">&hearts;</span> URL Shortener</h1>
</div>
<form method="post">
	<?php if(!empty($errors)):?>
		<p id="e"><?php echo $errors;?></p>
	<?php else: ?><?php if(isset($_POST['s']) && isset($success)):?>
	<p><b>Your URL has been shortend!</b></p>
	<p>Here is your short URL: <a href="<?php echo ROOT_URL.$tag;?>"
		target="_blank" rel="nofollow"><?php echo ROOT_URL.$tag;?></a></p>
	<?php else: ?>
	<p>Share a link and let them know you love it!</p>
	<?php endif; ?><?php endif; ?>
	<b id="l">Long URL</b><br />
	<input id="u" name="u" type="text" value="<?php echo isset($_POST['u']) ? htmlspecialchars($_POST['u']) : ''; ?>"/>
	<input id="s" type="submit" name="s" value="Shorten" /><br />
	<i>Tag<input id="t" name="t" type="text" />(optional)</i>
</form>
